...
class ClassTableModel(QAbstractTableModel):
    ...
    def _sync_mode(self) -> None:
        """Keep the image-level-mode flag current -- it changes what TOTAL counts."""
        self._in_image_level_mode = (
            self._current_row >= 0
            and self._dataset_model.get_annotation_mode() == "image_level"
        )
    ...
    def refresh_counts(self) -> None:
        ...
        self.dataChanged.emit(
            self.index(0, ClassColumns.TOTAL),
